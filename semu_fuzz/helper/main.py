...
def _parse_args():
    ...
    # Needed Parsers
    parser.add_argument('command', choices=['config', 'launch', 'stat', 'run', 'func', 'draw'], help="Helper to run. (1)config: Dump semu config for testcases. (2)launch: Dump vscode launch for testcases. (3)stat: Stat BB coverage and draw image for testcases. (4)run: Run afl test of testcases with nohup. (5)func: Stat new Function found using new_blocks.txt file. (6)draw: Draw BB coverage image using new_blocks.txt file.")
